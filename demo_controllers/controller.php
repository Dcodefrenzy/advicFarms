...
function updateProduct($dbconn,$post,$sess,$get){
  ...
  $stmt = $dbconn->prepare("UPDATE product SET product_name=:tt, price = :pri, description=:dec, created_by=:sess,  hash_id=:h, date_created=NOW(), time_created=NOW() WHERE hash_id=:get");
